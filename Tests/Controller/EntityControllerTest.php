...
namespace Ws\Bundle\GeneratorBundle\Tests\Controller;
...
class EntityControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'ws_bundle_generatorbundle_entitytype[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Edit')->form(array(
            'ws_bundle_generatorbundle_entitytype[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
